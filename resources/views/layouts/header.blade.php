...
<html class=no-js>
	...
	<head>
		...
		<link rel="shortcut icon" href=http://theme-shop.biz/6df2b309.favicon.ico>
				...
				<div class=scrollbar-padder>
					...
					<div class=sidebar-header>
						...
						<a data-ui-sref=app.dashboard.dashboard-1 class=ls-sm>
							<!-- <i class="fa fa-th"></i>  --> <span>P</span><span>ixels</span> 
						</a>
					</div>
					<!-- END - sidebar-header --> <!-- BEGIN - sidebar-avatar --> 
					<div class="sidebar-avatar text-center">
						<img src=images/9f2498a8.avatar1.png alt="" class="img-circle m-b-md" width=100 height=100> 
					...
					<ul id="navigation-items" class="nav">
						...
						<!-- li --> <!-- li --> 
						<li> <a href=app.calendar.html class=waves-effect> <i class=icon-calendar></i><span>Calendar</span> </a> </li>
						<!-- li --> <!-- li --> 
						<li> <a href=mail.html class=waves-effect> <i class=icon-envelope></i><span>Mail</span> </a> </li>
						<!-- li --> <!-- li --> 
						<li> <a href=index-2.html class=waves-effect> <i class=icon-home></i><span>Dashboard</span> </a> </li>
						<!-- li --> <!-- li --> 
						<li class=menu-header><span>Components</span></li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class=icon-screen-desktop></i><span>UI Elements</span> </a> <!-- ul --> 
							<ul class=sub-menu>
								<!-- li --> 
								...
								<!-- li --> <!-- li --> 
								<li> <a href=ui.notifications.html> <i class="fa fa-angle-right"></i><span>Notifications</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=ui.typography.html> <i class="fa fa-angle-right"></i><span>Typography</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=ui.grids.html> <i class="fa fa-angle-right"></i><span>Grids</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=ui.tabs.html> <i class="fa fa-angle-right"></i><span>Tabs</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=ui.widgets.html> <i class="fa fa-angle-right"></i><span>Widgets</span> </a> </li>
								<!-- li --> 
							</ul>
							<!-- ul --> 
						</li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class=icon-graph></i><span>Icons</span> </a> <!-- ul --> 
							<ul class=sub-menu>
								<!-- li --> 
								<li> <a href=icons.glyphicons.html> <i class="fa fa-angle-right"></i><span>Glyphicons</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=icons.font-awesome.html> <i class="fa fa-angle-right"></i><span>Font Awesome</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=icons.simple-line-icons.html> <i class="fa fa-angle-right"></i><span>Simple Line Icons</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=icons.themify.html> <i class="fa fa-angle-right"></i><span>Themify</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=icons.pixeden-7-stroke.html> <i class="fa fa-angle-right"></i><span>Pixeden 7 Stroke</span> </a> </li>
								<!-- li --> 
							</ul>
							<!-- ul --> 
						</li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class=icon-compass></i><span>Form Components</span> </a> <!-- ul --> 
							<ul class=sub-menu>
								<!-- li --> 
								<li> <a href=forms.inputs.html> <i class="fa fa-angle-right"></i><span>Inputs</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=forms.checkbox-and-radio.html> <i class="fa fa-angle-right"></i><span>Checkbox & Radio</span> </a> </li>
								<!-- li --> 
							</ul>
							<!-- ul --> 
						</li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class=icon-list></i><span>Tables</span> </a> <!-- ul --> 
							<ul class=sub-menu>
								<!-- li --> 
								<li> <a href=tables.basic.html> <i class="fa fa-angle-right"></i><span>Basic</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=tables.responsive.html> <i class="fa fa-angle-right"></i><span>Responsive</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=tables.advanced.html> <i class="fa fa-angle-right"></i><span>Advanced</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=tables.footable.html> <i class="fa fa-angle-right"></i> <span>Footable</span> </a> </li>
								<!-- li --> 
							</ul>
							<!-- ul --> 
						</li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class="fa fa-file-text-o"></i> <span>Pages</span> </a> <!-- ul --> 
							<ul class=sub-menu>
								<!-- li --> 
								<li> <a href=pages.blank.html> <i class="fa fa-angle-right"></i> <span>Blank Page</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=pages.profile.html> <i class="fa fa-angle-right"></i> <span>Profile</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=error.404.html> <i class="fa fa-angle-right"></i> <span>Error 404</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=error.500.html> <i class="fa fa-angle-right"></i> <span>Error 500</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=account.lockscreen.html> <i class="fa fa-angle-right"></i> <span>Lockscreen</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=account.sign-in.html> <i class="fa fa-angle-right"></i> <span>Login</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=account.sign-up.html> <i class="fa fa-angle-right"></i> <span>Register</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=account.forgot-password.html> <i class="fa fa-angle-right"></i> <span>Forgot Password</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=pages.invoice.html> <i class="fa fa-angle-right"></i> <span>Invoice</span> </a> </li>
								<!-- li --> <!-- li --> 
								<li> <a href=pages.pricing-table.html> <i class="fa fa-angle-right"></i> <span>Pricing Tables</span> </a> </li>
								<!-- li --> 
							</ul>
							<!-- ul --> 
						</li>
						<!-- li --> <!-- li --> 
						<li class=menu-header> <span>Charts</span> </li>
						<!-- li --> <!-- li --> 
						<li>
							<a href=javascript:void(0) class=waves-effect> <i class=icon-pie-chart></i> <span>Highcharts</span> </a> <!-- sub-menu --> 
							<ul class=sub-menu>
								<li> <a href=charts.highcharts-line.html> <i class="fa fa-angle-right"></i> <span>Line</span> </a> </li>
								<li> <a href=charts.highcharts-area.html> <i class="fa fa-angle-right"></i> <span>Area</span> </a> </li>
								<li> <a href=charts.highcharts-column-and-bar.html> <i class="fa fa-angle-right"></i> <span>Column &amp; Bar</span> </a> </li>
								<li> <a href=charts.highcharts-pie-and-donut.html> <i class="fa fa-angle-right"></i> <span>Pie &amp; Donut</span> </a> </li>
								<li> <a href=charts.highcharts-scatter-and-bubble.html> <i class="fa fa-angle-right"></i> <span>Scatter &amp; Bubble</span> </a> </li>
							</ul>
							<!-- sub-menu --> 
						</li>
						<!-- li --> 
					...
					<!-- END - sidebar-stats --> <!-- BEGIN - sidebar-storage-info --> 
					<div class=sidebar-storage-info>
						<div class=cloud-storage-info>
							<div class=user-storage-text>
								<p> <i class="fa fa-cloud"></i> Cloud Storage </p>
							</div>
							<div class=user-storage-graph>
								<!-- progress --> 
								<div class=progress style="height: 5px">
									<!-- progress-bar --> 
									<div class="progress-bar progress-bar-warning" role=progressbar aria-valuenow=60 aria-valuemin=0 aria-valuemax=100 style="width: 80%"> <span class=sr-only>80% Complete (warning)</span> </div>
									<!-- progress-bar --> 
								</div>
								<!-- progress --> 
							</div>
						...
						<div class=email-storage-info>
							<div class=user-storage-text>
								<p> <i class="fa fa-inbox"></i> Email Storage </p>
							</div>
							<div class=user-storage-graph>
								<!-- progress --> 
								<div class=progress style="height: 5px">
									<!-- progress-bar --> 
									<div class="progress-bar progress-bar-success" role=progressbar aria-valuenow=60 aria-valuemin=0 aria-valuemax=100 style="width: 50%"> <span class=sr-only>50% Complete (warning)</span> </div>
									<!-- progress-bar --> 
								</div>
								<!-- progress --> 
							</div>
			...
			<div class="view-wrapper clearfix">
				...
				<header class=header-container>
					...
					<ul class=header-menu-left>
						...
						<!-- li --> <!-- li --> 
						<li>
							<!-- a --> <a href=javascript:void(0)> <i class="fa fa-inbox fa-fw"></i> </a> <!-- a --> 
						</li>
						<!-- li --> <!-- li --> 
						<li class=notifications-li>
							<a href=javascript:void(0) data-toggle=dropdown> <i class="fa fa-bell fa-fw"></i> </a> 
							<ul class=dropdown-menu>
								<!-- li --> 
								<li>
									<p>You've got 4 new notifications</p>
								</li>
								<!-- li --> <!-- li --> 
								<li>
									<a href=javascript:void(0) class=success-notification>
										<div class=media>
											<div class=pull-left> <i class="fa fa-download"></i> </div>
											<div class=media-body>
												<p>1 item downloaded</p>
								...
								<!-- li --> <!-- li --> 
								<li>
									<a href=javascript:void(0) class=warning-notification>
										<div class=media>
											<div class=pull-left> <i class="fa fa-upload"></i> </div>
											<div class=media-body>
												<p>4 items uploading</p>
												<p class=notification-time>56 mins ago</p>
											</div>
										</div>
									</a>
								</li>
									...
									<a href=javascript:void(0) class=success-notification>
										<div class=media>
											...
											<div class=media-body>
												...
												<!-- progress --> 
												<p class=notification-time>10 mins remaining</p>
											</div>
										</div>
									</a>
								</li>
								<!-- li --> <!-- li --> 
								<li>
									<a href=javascript:void(0) class=error-notification>
										<div class=media>
											<div class=pull-left> <i class="fa fa-exclamation-triangle"></i> </div>
											<div class=media-body>
												<p>Error in registration</p>
					...
					<ul class=header-menu-right>
						...
						<li> <a href=javascript:void(0) data-toggle-class=quickchat-visible data-target=.content-wrapper> <i class="fa fa-comments fa-fw"></i> </a> </li>
					</ul>
					<!-- header-menu --> 
				</header>
	...
	<!-- col-md-12 --> 
		...
		<!-- Google Analytics: change UA-XXXXX-X to be your site's ID. --> <script>(function(b,o,i,l,e,r){b.GoogleAnalyticsObject=l;b[l]||(b[l]=
